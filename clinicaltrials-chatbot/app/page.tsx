        ...
        <>
          ...
          <div className="relative max-w-md mx-auto w-full">
            <Card className="p-2 space-y-2 w-full animate-fadeIn">
              ...
              <Button type="submit" className="bg-[#1159af] text-teal-300 hover:bg-[#0d478f]">Send</Button>
              </form>

              {/* Restart Chat Button - Below Send Button */}
              <Button
                onClick={restartChat}
                className="w-full bg-[#1159af] hover:bg-[#0d478f] text-teal-300 flex items-center justify-center gap-2"
                title="Restart Chat"
              >
